...
extension Lambda {
    internal struct Configuration: CustomStringConvertible {
        ...
        struct RuntimeEngine: CustomStringConvertible {
            ...
            init(baseURL: String? = nil, keepAlive: Bool? = nil, requestTimeout: TimeAmount? = nil, ipPort: String? = nil) {
                let ipPort = (ipPort ?? env("AWS_LAMBDA_RUNTIME_API"))?.split(separator: ":") ?? ["127.0.0.1", "7000"]
