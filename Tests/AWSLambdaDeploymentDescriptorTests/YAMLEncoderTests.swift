...
class TestYAMLEncoder: XCTestCase {
  ...
  func test_codingOfInt64() {
    #if !arch(arm)
      test_codingOf(value: Int64(-9_000_000_000_000_000_042), toAndFrom: "-9000000000000000042")
    #endif
  }

  func test_codingOfUInt64() {
    #if !arch(arm)
      test_codingOf(value: UInt64(9_000_000_000_000_000_042), toAndFrom: "9000000000000000042")
    #endif
  }
  ...
  func test_codingOfInt() {
    ...
    case 8:  // 64-bit
        ...
        break
      #else
        test_codingOf(value: Int(-9_000_000_000_000_000_042), toAndFrom: "-9000000000000000042")
      #endif
    default:
  ...
  func test_codingOfUInt() {
    ...
    case 8:  // 64-bit
        ...
        break
      #else
        test_codingOf(value: UInt(9_000_000_000_000_000_042), toAndFrom: "9000000000000000042")
      #endif
    default:
