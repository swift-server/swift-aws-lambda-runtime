> [!IMPORTANT]
> This is the doc for the Swift AWS Lambda Runtime v1 (tagged as 1.0.0-alpha.x) in the repo. 
> If you plan to develop againt the Runtime v2, check this [readme](readme.md)) instead.
